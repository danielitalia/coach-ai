...
async function scoreClient(tenantId, phone, db) {
  ...
  // Fattore 4: Nessun messaggio recente (peso 0.10 o 0.30 se mancano check-in)
  ...
  `, [
    ...
    JSON.stringify({
      daysSinceLastCheckin: daysSinceLastCheckin === null ? 999 : daysSinceLastCheckin,
      daysSinceLastMessage: daysSinceLastMessage === null ? 999 : daysSinceLastMessage,
      totalCheckins30d,
      userMessages30d: userMessages.length,
      weeklyHistory,
      checkinTrend,
      factors: {
        inactivity: daysSinceLastCheckin === null ? 999 : daysSinceLastCheckin,
        trend: checkinTrend,
        motivation: motivationLevel,
        messageSilence: daysSinceLastMessage === null ? 999 : daysSinceLastMessage,
